// KKShadersPlus URP - Vertex Lights Specular
// Adapted for URP

#ifndef KKP_VERTEX_LIGHTING_SPECULAR_URP
#define KKP_VERTEX_LIGHTING_SPECULAR_URP
...
float GetVertexSpecularDiffuse(KKVertexLight lights[4], float3 normal, float3 viewDir, float specularPower, inout float3 specularVertexMesh) {
    ...
    for(int i = 0; i < 4; i++) {
        ...
        bool lightExists = any(light.pos != 0.0);
